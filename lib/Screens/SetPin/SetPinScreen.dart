...
class _SetPinScreenState extends State<SetPinScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SetpinBloc, SetpinState>(
      ...
      buildWhen: (prevState, state) {
        if (state is SetpinInitial) {
          return false;
        }

        if (state is SetPinUpdateState) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                "Please secure your account by using a security PIN.",
                                style: TextStyle(
                                    fontWeight: FontWeight.w300,
                                    color: kTextColor5,
                                    fontSize: screenUtil.setSp(16.0),
                ...
                child: Material(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: Text(
                          "Your PIN has been saved successfully.",
                          style: TextStyle(
                              color: kTextColor3,
                              fontFamily: "Poppins",
                              fontSize: screenUtil.setSp(16.0),
  ...
  // type 1. validate enter pin 2. validate confirm pin 3. validate all
        ...
        if (from == 1) {
          HelperUtil.checkInternetConnection().then((internet) {
            if (internet) {
              ...
              setPinBloc.add(SetSecurityPinEvent(pin: enteredPin));
            } else {
              toastUtil.showMsg(Constant.noInternetMsg, Colors.black,
                  Colors.white, 12.0, "short", "bottom");
            }
